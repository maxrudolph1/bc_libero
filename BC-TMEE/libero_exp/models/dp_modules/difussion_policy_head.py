...
def simple_minimum_error_entropy_loss(y_pred, y_true, sigma=0.5, eps=1e-8):
        # e: [batch, dim]
        e = y_pred - y_true
        e = e.view(e.size(0), -1)
        n = e.size(0)
...
class DPHead(nn.Module):
    ...
    def loss(self, x, z,sigma=0.5):
        ...
        mee_loss = simple_minimum_error_entropy_loss(noise_pred, noise, sigma)

        return loss * self.loss_coef , mee_loss
