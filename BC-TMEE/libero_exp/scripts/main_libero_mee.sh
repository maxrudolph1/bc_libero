...
# cd /media/code/BC-IB && bash libero_exp/scripts/main_libero_mee.sh 'libero_spatial' 'bc_mee_policy' 'transformer' 1.0 0
# cd /media/code/BC-IB && bash libero_exp/scripts/main_libero_mee.sh 'libero_goal' 'bc_mee_policy' 'rnn'  1.0 0
# cd /media/code/BC-IB && bash libero_exp/scripts/main_libero_mee.sh 'libero_10' 'bc_mee_policy' 'dp'  1.0 0
